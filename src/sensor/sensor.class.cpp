...
Sensor::Sensor() {
  ...
  currentSensor.setSampleTime(INA226_VBUS, INA226_CONV_2116US);   // Повысим время выборки напряжения в 8 раз
  currentSensor.setSampleTime(INA226_VSHUNT, INA226_CONV_2116US); // Повысим время выборки тока в 8 раз
